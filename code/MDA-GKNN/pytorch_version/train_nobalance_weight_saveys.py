...
if __name__ == '__main__':
    ...
    np.savez_compressed('/home/chujunyi/4_GNN/GraphSAINT/miRNA_disease__case_study/task_Tm_unbalanced_15knn_lr0.01_weight10_fold2.npz', ys_train = ys_train, ys_test = ys_test)
