...
if __name__ == '__main__':
    ...
    np.savez_compressed('/home/chujunyi/4_GNN/GraphSAINT/miRNA_disease__case_study/task_Td_balanced_5knn_lr0.001_fold4.npz', ys_train = ys_train, ys_test = ys_test)
